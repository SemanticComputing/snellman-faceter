(function() {
    ...
    * The controller.
    */
    .controller('PaheController', PaheController);

    /* @ngInject */
    function PaheController($scope, FacetHandler, paheService, facetUrlStateHandlerService,
        ...
        function updateResults(event, facetSelections) {
            ...
            // The findsService returns a (promise of a) pager object.
            return paheService.getResults(facetSelections)
            .then(function(pager) {
                if (uid === updateId) {
                    vm.pager = pager;
